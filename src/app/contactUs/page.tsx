...
function ImageBox(){
  ...
  return(
    <>
      {
        imgBoxItems.map((item, idx) => (
          <div key={idx} className="hidden md:flex items-center justify-center gap-2 min-h-[50px] w-full md:w-[20%] min-w-[200px] rounded-[8px] border border-[#ffffff80] bg-[#ffffff15]">
            <span>
                <Image width={30} height={30} src={item.img} alt="bag" />
            </span>
            {item.text}
          </div>
        ))
              ...
              info.map((item, idx) => (
                <div key={idx} className="flex items-center justify-start gap-2 min-h-[50px] w-full md:w-[100%] min-w-[200px] rounded-[8px] border border-[#ffffff80] bg-[#ffffff15] p-2">
                  <span className="w-[50px] h-[50px] rounded-[4px] flex items-center justify-center">
                      <Image width={1000} height={1000} src={item.logo} alt={item.alt} className="w-[50%] h-auto"/>
                  </span>
