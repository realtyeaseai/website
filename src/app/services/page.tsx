        ...
        <>
          <div className="relative flex items-center justify-between md:flex-row flex-col gap-8 w-full h-[80%] bg-[#010101]">
            ...
            <span className="w-full md:w-[50%] h-full flex flex-col">
              ...
              <a href="/contactUs" className="h-[50px] text-black w-full rounded-[4px] text-center flex items-center justify-center bg-[#ffffff] hover:bg-[#ffffffdc] transition-all duration-300 ease-in mt-4">
                Contact Us
              </a>
            </span>
            {/*--------------- image --------------*/}
