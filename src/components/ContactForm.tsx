...
export default function ContactForm() {
  ...
  return (
    <div className="bg-gradient-to-tr to-[#0072feb5] from-black border-2 dark:border-[#ffffffb1] min-h-[750px] max-w-4xl w-full md:w-auto rounded-3xl flex items-center justify-center flex-col p-6 dark:dark:text-white font-bold text-white border-black shadow-black shadow-md">
