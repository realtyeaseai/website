...
function InputTab(){
  return (
    <div className="m-2 mb-10 md:w-[60%] w-full flex justify-center flex-col md:flex-row mt-12">
    ...
    <a href="#" className="relative inline-flex md:mt-4  h-12 overflow-hidden rounded-full p-[2px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
