...
function TextBoxWithContactBtn(){
  return(
      <div className="w-full min-h-fit pb-20 pl-4 md:basis-[45%]">
        ...
        Explore our frequently asked questions below to find clarity on our services, processes, and everything in between. Can&apos;t find what you&apos;re looking for? <br/> <Link href="/contact" className="text-[#1ca2dc] font-semibold hover:border-b-2">Contact us</Link> - we&apos;re always here to help!
