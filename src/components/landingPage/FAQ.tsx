...
function TextBoxWithContactBtn(){
  return(
      <div className="w-full min-h-[400px] pl-4 md:basis-[45%]">
        ...
        {/* Button  */}
        <a href="/contactUs" className="relative inline-flex md:mt-8 mt-6 h-12 overflow-hidden rounded-full p-[2px] md:ml-6 focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
          ...
          {faqs.map((faq, i) => (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                <span>{openIndex === i ? <Image width={1000} height={1000} src="/faqItems/Minus.svg" alt="-" className="w-6 h-auto"/>: <Image width={1000} height={1000} src="/faqItems/Add.svg" alt="+" className="w-6 h-auto"/>}</span>
              </div>
